<%@ Page Language="C#" MasterPageFile="~/MasterPages/SingleColumn.Master" AutoEventWireup="true"
    CodeBehind="PrzegladDziennikaSimple.aspx.cs" Inherits="Pemi.Esoda.Web.UI.PrzegladDziennikaSimple"
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    ...
    <div id="singleColumn" runat="server">
        <asp:LinkButton runat="server" ID="rezerwacja" Text="[Rezerwacja pozycji w dzienniku]" />
...
<legend>Filtrowanie rejestru</legend>--%>
        <asp:Panel ID="pnlSearch" runat="server">
            ...
            <table class="searchForm" runat="server" id="searchTable">
                <tr>
                    <th>
                ...
                <th>
                    <asp:Label ID="Label4" runat="Server" AssociatedControlID="snadawca" Text="Nadawca" />
                </th>
                --%>
                    <td rowspan="2">
            ...
            <div runat="server" id="przedzialDat" visible="false">
                ...
                <asp:LinkButton runat="server" ID="zatwierdzWyborDat" Text="ZatwierdŸ wybór zakresu" />
                <br />
                <br />
            </div>
            <asp:LinkButton runat="server" ID="lbtnAdvancedSearch" Text="Wyszukiwanie zaawansowane"
                PostBackUrl="~/Aplikacje/DziennikKancelaryjny/PrzegladDziennika.aspx" />
        </asp:Panel>
        <div id="pager">
            ...
            <asp:GridView GridLines="None" runat="server" ID="lista" CssClass="listaPozycjiRejestru grid fullWidth"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <%#XPath("nadawca")%>
                            <asp:HyperLink runat="server" class="stamp" Text="&nbsp;" title="potwierdzenie z³o¿enia przesy³ki"  NavigateUrl='<%#XPath("id","~/Aplikacje/Raporty/PotwierdzenieRejestracji.aspx?pid={0}")%>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <HeaderTemplate>
