...
<asp:BoundField HeaderText="Data wszczêcia sprawy" DataField="CaseStartDate" DataFormatString="{0:yyyy-MM-dd}"/>
<asp:BoundField HeaderText="Data zakoñczenia sprawy" DataField="CaseEndDate" DataFormatString="{0:yyyy-MM-dd}" />
