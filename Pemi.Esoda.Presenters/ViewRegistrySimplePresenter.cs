...
{
    public class ViewRegistrySimplePresenter : BasePresenter
    {
        private int registryId;

        private IViewRegistrySimpleView view = null;

        private IViewRegistryTask service = null;

        private ISessionProvider session = null;

        public ViewRegistrySimplePresenter(IViewRegistrySimpleView view, ISessionProvider sessionProvider)
        {
